    ...
    if (existing) {
      ...
      const { error } = await supabase
        ...
        .update({
          ...
          pnl_usd: pnlUsd,
          pnl_pct: pnlPct,
          r_multiple_at_close: trade.r_multiple_at_close,
  ...
  try {
    ...
    return {
      ...
      rawTrades: trades.map(t => ({
        ...
        initialRiskUsd: t.initial_risk_usd,
        rMultiple: t.r_multiple_at_close,
        regime: t.market_regime_at_entry,
        fundingRate: t.funding_rate_at_entry,
