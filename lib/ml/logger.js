// ============================================================
// ML Signal Snapshot Recorder — xsjprd55
// Records every signal into the local SQLite for model training.
// NOTE: This is NOT a console logger. For console logging, import
// from '../logger.js' (the root logger). This file was renamed
// from 'logger.js' to 'signalRecorder.js' to avoid confusion.
// ============================================================
