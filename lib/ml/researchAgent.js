...
import { storeResearchSource, getUnusedResearchSources } from './supabase-db.js';
...
export async function saveStrategyProposalToDb(proposal) {
  const result = await saveProposal({
    ...
    tags: proposal.tags || [],
    sourceName: proposal.sourceName || 'research_agent',
    sourceCredibility: proposal.sourceCredibility || 0.5,
  });
