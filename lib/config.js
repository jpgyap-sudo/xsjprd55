...
// Works for both Vercel (serverless) and VPS deployments.
// ============================================================
...
export const config = {
  ...
  APP_URL: process.env.APP_URL || process.env.VERCEL_PRODUCTION_URL || '',
  ...
  DEFAULT_PAIRS: (process.env.DEFAULT_PAIRS || 'BTC/USDT,ETH/USDT,SOL/USDT,BNB/USDT,XRP/USDT').split(','),
  ...
  // ── Cron (VPS only; Vercel uses vercel.json) ─────────────
