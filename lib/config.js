...
export const config = {
  ...
  // Brain-specific Ollama model (defaults to OLLAMA_MODEL)
  OLLAMA_BRAIN_MODEL: process.env.OLLAMA_BRAIN_MODEL || process.env.OLLAMA_MODEL || 'phi3:mini',
  // Chat-specific Ollama model (defaults to OLLAMA_MODEL)
  OLLAMA_CHAT_MODEL: process.env.OLLAMA_CHAT_MODEL || process.env.OLLAMA_MODEL || 'phi3:mini',

  // ── OpenClaw (analysis agent) ─────────────────────────────
  OPENCLAW_CLI_PATH: process.env.OPENCLAW_CLI_PATH || 'openclaw',
  ...
  ENABLE_STRATEGY_MONITOR_WORKER: boolEnv(process.env.ENABLE_STRATEGY_MONITOR_WORKER, true),
  ...
  MOCK_STARTING_BALANCE: numEnv(process.env.MOCK_STARTING_BALANCE, 1_000_000),
  ...
  // ── Mock Trader Quality Improvements (v2) ─────────────────
  ENABLE_SIGNAL_QUALITY_GATE: boolEnv(process.env.ENABLE_SIGNAL_QUALITY_GATE, true),
  ENABLE_MARKET_REGIME_FILTER: boolEnv(process.env.ENABLE_MARKET_REGIME_FILTER, true),
  ENABLE_STRATEGY_SCORECARD: boolEnv(process.env.ENABLE_STRATEGY_SCORECARD, true),
  ENABLE_DYNAMIC_CONFIDENCE: boolEnv(process.env.ENABLE_DYNAMIC_CONFIDENCE, true),
  ENABLE_POST_TRADE_LEARNING: boolEnv(process.env.ENABLE_POST_TRADE_LEARNING, true),
  ENABLE_EXIT_ENGINE: boolEnv(process.env.ENABLE_EXIT_ENGINE, true),
  ENABLE_TRADING_WINDOW_FILTER: boolEnv(process.env.ENABLE_TRADING_WINDOW_FILTER, true),
  ENABLE_STRATEGY_AUTO_THROTTLE: boolEnv(process.env.ENABLE_STRATEGY_AUTO_THROTTLE, true),

  // Quality gate thresholds
  SIGNAL_MIN_CONFIDENCE: numEnv(process.env.SIGNAL_MIN_CONFIDENCE, 0.65),
  SIGNAL_MIN_RR: numEnv(process.env.SIGNAL_MIN_RR, 1.5),
  SIGNAL_MAX_AGE_MINUTES: numEnv(process.env.SIGNAL_MAX_AGE_MINUTES, 5),
  SIGNAL_COOLDOWN_SAME_SYMBOL_MINUTES: numEnv(process.env.SIGNAL_COOLDOWN_SAME_SYMBOL_MINUTES, 60),

  // Auto-throttle thresholds
  THROTTLE_MIN_WIN_RATE: numEnv(process.env.THROTTLE_MIN_WIN_RATE, 0.45),
  THROTTLE_MIN_EXPECTANCY: numEnv(process.env.THROTTLE_MIN_EXPECTANCY, 0),
  THROTTLE_LOOKBACK_TRADES: numEnv(process.env.THROTTLE_LOOKBACK_TRADES, 30),
  THROTTLE_COOLDOWN_MINUTES: numEnv(process.env.THROTTLE_COOLDOWN_MINUTES, 120),
