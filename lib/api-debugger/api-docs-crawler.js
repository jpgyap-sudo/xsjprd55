...
function defaultDocUrls() {
  return [
    { provider: 'kimi', url: 'https://platform.moonshot.cn/docs/api/chat#%E5%9F%BA%E6%9C%AC%E4%BF%A1%E6%81%AF' },
    { provider: 'kimi', url: 'https://platform.moonshot.cn/docs/api/errors' },
