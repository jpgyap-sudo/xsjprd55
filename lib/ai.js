...
export async function generateAIResponse(systemPrompt, userPrompt, opts = {}) {
  ...
  try {
    ...
    console.warn('[AI] Kimi failed, falling back to Claude:', kimiErr.message);
    ...
    try {
      ...
      throw new Error(`AI providers exhausted. Kimi: ${kimiErr.message} | Claude: ${claudeErr.message}`);
    }
  }
}
