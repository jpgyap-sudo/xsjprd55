-- ============================================================
-- Create product_features and deploy_history ONLY
-- Safe to run even if other schemas have type conflicts
-- 2026-04-29
-- ============================================================

-- 1. PRODUCT_FEATURES (feature inventory + health tracking)
...
-- Seed: Initial feature inventory (idempotent)
...
-- 2. DEPLOY_HISTORY (tracks every deploy check vs GitHub)
...
-- Verify
SELECT 'product_features' AS table_name, COUNT(*) AS row_count FROM product_features
UNION ALL
SELECT 'deploy_history' AS table_name, COUNT(*) AS row_count FROM deploy_history;
